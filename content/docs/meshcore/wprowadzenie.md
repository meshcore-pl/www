...
Dlatego przy dużym zagęszczeniu repeaterów nie warto uruchamiać kolejnego, jeśli nie poprawia on zasięgu ani nie łączy odseparowanych obszarów.
Dodatkowy węzeł może wtedy jedynie zwiększać liczbę retransmisji i kolizji.
