...
# Lista anten
Spis anten których używamy/używaliśmy. Polecamyte od GIZONT-a. Nie wierz w podany zysk.

## Pod Companiony
1. [AliExpress](https://pl.aliexpress.com/item/1005004607615001.html) `(zysk 10 dBi)` - znakomita pod companiona, da się na niej sporo km wykręcić.
2. [AliExpress](https://pl.aliexpress.com/item/1005007308749444.html) `(zysk 10 dBi)` - Nie kupuj opcji z kablem. Przeczytaj info na samym dole.
